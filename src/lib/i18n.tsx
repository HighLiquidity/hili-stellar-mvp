...
const dictionaries: Record<Locale, TranslationTree> = {
  pt: {
    ...
    auth: {
      ...
      subtitle: 'Faça login com qualquer e-mail e senha para navegar pelo MVP.',
      email: 'E-mail',
      password: 'Senha',
      emailPlaceholder: 'voce@empresa.com',
      passwordPlaceholder: 'Digite qualquer senha',
    ...
    pages: {
      deposit: {
        ...
        description: 'Área preparada para receber o formulário de criação e acompanhamento de depósitos.',
        cardTitle: 'Próxima integração',
        cardBody: 'Conecte aqui a API de geração de instruções PIX, status da ordem e limites operacionais.',
        checklistTitle: 'O que esta tela já resolve',
        checklistOne: 'Hierarquia visual para formulário principal',
        checklistTwo: 'Espaço para resumo da operação e mensagens de status',
        checklistThree: 'Estrutura pronta para validações e chamadas futuras',
      },
      withdraw: {
        eyebrow: 'PIX',
  ...
  en: {
    ...
    auth: {
      ...
      subtitle: 'Sign in with any email and password to navigate through the MVP.',
      email: 'Email',
      password: 'Password',
      emailPlaceholder: 'you@company.com',
      passwordPlaceholder: 'Type any password',
    ...
    pages: {
      deposit: {
        ...
        description: 'Area prepared to receive the deposit creation and tracking form.',
        cardTitle: 'Next integration',
        cardBody: 'Connect the PIX instruction generation API, order status, and operational limits here.',
        checklistTitle: 'What this screen already solves',
        checklistOne: 'Visual hierarchy for the main form',
        checklistTwo: 'Space for operation summary and status messages',
        checklistThree: 'Structure ready for future validations and calls',
      },
      withdraw: {
        eyebrow: 'PIX',
        badge: 'Rules pending',
