  ...
  pt: {
    ...
    pages: {
      ...
      eventLogs: {
        ...
        description:
          'Histórico de tentativas de depósito e saque fiat (geração de QR, validações e erros).',
  ...
  en: {
    ...
    pages: {
      ...
      eventLogs: {
        eyebrow: 'Admin',
        title: 'Event logs',
        description: 'History of fiat deposit and withdrawal attempts (QR generation, validation, errors).',
